export const products = [
  ...
  {
    id: 15,
    image: "/src/assets/mug5.png",
    name: "Carter Everywhere Mug",
    description:
  ...
  },
  {
    ...
    description:
      "Tropical Weather is a seasonal blend that celebrates coffees from our favorite coffee producing country: Ethiopia.",
    category: "coffee",
    price: "21€",
    stock: 0,
  },
  ...
  },
  {
    ...
    name: "Mengesha Farm Chelchele Ethiopia",
    description:
  ...
  },
  {
    ...
    description:
      "This coffee is one of Cat & Cloud’s year-round favorites, grown in Brazil’s ancient volcanic valley of Vale de Grama and given a unique “pulped natural” processing. This method was pioneered in Brazil and is similar to natural processing except the skin of the coffee cherry is removed before drying, leaving just the pulp around the bean and resulting in a sweet full-bodied yet clean tasting cup. Cat & Cloud found notes of peanut butter and jelly in this coffee, but it was more like peanut M&Ms on our end. We tasted milk chocolate, peanut, honey, a lime acidity and a tea-like body.",
    category: "coffee",
    price: "16€",
    stock: 2,
  },
  {
    id: 14,
    image: "/src/assets/mug4.png",
    name: "Carter Move Mug + Splash Guard",
    description:
  ...
  {
    id: 13,
    image: "/src/assets/mug3.png",
    name: "Carter Move Mug + 360° Sip Lid",
    description:
